...
#                     clnt_x = np.zeros((clnt_data_list[clnt__],self.channels,self.height,self.width),dtype=np.float32)
#                     clnt_y = np.zeros((clnt_data_list[clnt__],1),dtype=np.uint8)
#                     np.save('%s/%s/clnt_x_%d.npy' % (self.data_path,self.name,clnt__), clnt_x)
#                     np.save('%s/%s/clnt_y_%d.npy' % (self.data_path,self.name,clnt__), clnt_y)
                # ----    
...
#                         clnt_x = np.load('%s/%s/clnt_x_%d.npy' % (self.data_path,self.name,curr_clnt))
#                         clnt_y = np.load('%s/%s/clnt_y_%d.npy' % (self.data_path,self.name,curr_clnt))
